...
class Edit_laboratory_services_controller extends GetxController{
  ...
  late String status;
  late String price;
  Edit_laboratory_service_services services =Edit_laboratory_service_services(Get.find());
  ...
  edit_service() async{
    ...
    update();
    var response =await services.edit_laboratory_service(id,id_type, name, details, status, price);
