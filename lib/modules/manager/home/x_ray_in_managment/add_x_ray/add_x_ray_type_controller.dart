...
class Add_xray_type_controller extends GetxController{


  GlobalKey<FormState> formstate= GlobalKey<FormState>();
  late String name;
  Add_x_ray_type_services services =Add_x_ray_type_services(Get.find());
  ...
  add_type_xray() async{
    ...
    update();
    var response =await services.add_type_xray(id_section, name);
