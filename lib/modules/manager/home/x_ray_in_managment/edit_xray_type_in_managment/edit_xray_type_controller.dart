...
/////////////////
class Edit_xray_type_controller extends GetxController {
  GlobalKey<FormState> formstate4 = GlobalKey<FormState>();
  late String name;
  late int id;
  late int id_section;
  Edit_xray_type_services services = Edit_xray_type_services(Get.find());
  ...
  edit_xray_type() async {
    statusRequest = StatusRequest.loading;
    update();
    var response = await services.edit_xray_type(id,id_section,name);
