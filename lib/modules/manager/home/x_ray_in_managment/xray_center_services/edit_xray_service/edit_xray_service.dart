...
import 'package:project_after_update/modules/manager/home/x_ray_in_managment/xray_center_services/edit_xray_service/edit_xray_service_controller.dart';
import 'package:project_after_update/static_colors/StaticColors.dart';

class Edit_xray_service extends StatelessWidget {
  const Edit_xray_service({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Edit_xray_services_controller controller =
    Get.put<Edit_xray_services_controller>(Edit_xray_services_controller());
    return Scaffold(
        body: GetBuilder<Edit_xray_services_controller>(builder: (controller){
          return
            Container(
              child: ListView(
                children: [
