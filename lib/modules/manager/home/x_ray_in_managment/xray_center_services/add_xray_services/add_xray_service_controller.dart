...
import 'package:project_after_update/modules/manager/home/x_ray_in_managment/xray_center_services/add_xray_services/add_xray_service_services.dart';
import 'package:project_after_update/secure_storage/secure_storage.dart';
class Add_xray_services_controller extends GetxController{
  ...
  late String status;
  late String price;
  Add_xray_service_services services =Add_xray_service_services(Get.find());
  ...
  add_service() async{
    ...
    update();
    var response =await services.add_xray_service(id_type, name, details, status, price);
