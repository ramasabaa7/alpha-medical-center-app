...
class Add_xray_service_services {
  String bearer = "Bearer";
  Crud crud;

  Add_xray_service_services(this.crud);
  Secury_storage secury = new Secury_storage();
  late var message;
  add_xray_service(int id_type,String name,String details,String status,String price) async {
