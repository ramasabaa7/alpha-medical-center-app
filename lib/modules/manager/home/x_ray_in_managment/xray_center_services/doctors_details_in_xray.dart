...
import 'package:project_after_update/modules/manager/home/x_ray_in_managment/xray_center_services/doctors_details_in_xray_controller.dart';
import 'package:project_after_update/static_colors/StaticColors.dart';

class Doctors_details_in_xray extends StatelessWidget {
  const Doctors_details_in_xray({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Doctor_details_in_xray_controller controller =Get.put(Doctor_details_in_xray_controller());
    return Scaffold(
      body: GetBuilder<Doctor_details_in_xray_controller>(builder: (controller){
        return
