...
import 'package:project_after_update/modules/manager/home/all_employee_status/all_employee_status_services.dart';
...
class all_employee_manager_controller extends GetxController {
  all_employee_manager_services services =
  all_employee_manager_services(Get.find(), Get.find());
