...
import 'package:project_after_update/modules/manager/home/ambulance_in_managment/edit_service_type_ambulance/edit_service_type_ambulance_services.dart';
...
/////////////////
class Edit_service_type_ambulance_controller extends GetxController {
  GlobalKey<FormState> formstate4 = GlobalKey<FormState>();
  late String name;
  late int id;
  late int id_section;
  Edit_service_type_ambulance_services services = Edit_service_type_ambulance_services(Get.find());
