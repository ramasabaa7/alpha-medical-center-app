...
class EDit_profile_info_managment extends StatelessWidget {
  Edit_profile_info_managment_controller controller = Get.put<Edit_profile_info_managment_controller>(Edit_profile_info_managment_controller());
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
          child: GetBuilder<Edit_profile_info_managment_controller>(builder:(controller){
