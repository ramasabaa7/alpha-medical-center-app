...
import 'package:project_after_update/modules/manager/home/finance_in_managment/finance_in_managment_services.dart';
...
class Finance_in_managment_controller extends GetxController {
  bool droped = false;
  Finance_in_managment_services services = Finance_in_managment_services(Get.find(),Get.find());
