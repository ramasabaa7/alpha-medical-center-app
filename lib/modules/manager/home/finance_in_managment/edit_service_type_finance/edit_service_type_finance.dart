...
import 'package:project_after_update/modules/manager/home/finance_in_managment/edit_service_type_finance/edit_service_type_finance_controller.dart';
...
class Edit_service_type_finance extends StatelessWidget {
  const Edit_service_type_finance({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Edit_service_type_finance_controller controller =Get.put(Edit_service_type_finance_controller());
    return Scaffold(
        appBar: AppBar(
          backgroundColor: StaticColor.primarycolor,
        ),
        body: GetBuilder<Edit_service_type_finance_controller>(builder: (controller){
          return
