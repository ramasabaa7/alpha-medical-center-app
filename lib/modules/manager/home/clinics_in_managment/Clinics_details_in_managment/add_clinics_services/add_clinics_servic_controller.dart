...
class Add_clinics_services_controller extends GetxController{
  ...
  late String status;
  late String price;
  Add_clinics_service_services services =Add_clinics_service_services(Get.find());
  ...
  add_service() async{
    ...
    update();
    var response =await services.add_clinic_service(id_type, name, details, status, price);
