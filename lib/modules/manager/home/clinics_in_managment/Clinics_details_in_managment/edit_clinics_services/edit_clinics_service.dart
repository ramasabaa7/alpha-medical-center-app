...
class Edit_clinics_service extends StatelessWidget {
  const Edit_clinics_service({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Edit_clinics_services_controller controller =
    Get.put<Edit_clinics_services_controller>(Edit_clinics_services_controller());
    return Scaffold(
        body: GetBuilder<Edit_clinics_services_controller>(builder: (controller){
          return
            Container(
              child: ListView(
                children: [
