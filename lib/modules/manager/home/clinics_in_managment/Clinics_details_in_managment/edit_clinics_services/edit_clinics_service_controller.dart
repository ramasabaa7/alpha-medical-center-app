...
class Edit_clinics_services_controller extends GetxController{
  ...
  late String status;
  late String price;
  Edit_clinics_service_services services =Edit_clinics_service_services(Get.find());
  ...
  edit_service() async{
    ...
    update();
    var response =await services.edit_clinic_service(id,id_type, name, details, status, price);
