...
class Doctor_details_in_manamgment_controller extends GetxController {


  Doctor_details_in_managment_services services = Doctor_details_in_managment_services(Get.find());
