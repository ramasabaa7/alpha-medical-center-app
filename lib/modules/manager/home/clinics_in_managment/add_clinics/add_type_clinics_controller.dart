...
class Add_clinics_controller extends GetxController{
  ...
  late String name;
  Add_type_clinics_services services =Add_type_clinics_services(Get.find());
  ...
  add_type_clinics() async{

    statusRequest=StatusRequest.loading;
    update();
    var response =await services.add_type_clinics(id_section, name);
