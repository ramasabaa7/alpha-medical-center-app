...
class DetailVisteLabPage extends StatefulWidget {
  @override
  detailvistelab createState() => detailvistelab();
}


class detailvistelab extends State<DetailVisteLabPage> {
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      return Container(
                          ...
                          Column(children: [
                            ...
                            widget1('نوع التحليل', '${controller.data[0][index]['required_patient_services']['center_service']['Name']}', Icons.edit_note_sharp),
                            widget1(
                                'تقرير الطبيب',
