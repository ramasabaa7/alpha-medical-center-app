...
class Clinics_section_in_finance_controller extends GetxController {
  bool droped = false;
  Clinics_section_in_finance_services services = Clinics_section_in_finance_services(Get.find(),Get.find());
