...
class Finance_section_in_finance_controller extends GetxController {
  bool droped = false;
  Finance_section_in_finance_services services = Finance_section_in_finance_services(Get.find(),Get.find());
