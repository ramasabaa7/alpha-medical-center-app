...
import 'package:project_after_update/modules/financial/Receipts/update_receipts/update_receipts_controller.dart';
...
class update_receipts extends StatelessWidget {
  const update_receipts({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Update_receipts_controller controller = Get.put(Update_receipts_controller());
    return SafeArea(
      child: Scaffold(
          appBar: AppBar(
            backgroundColor: StaticColor.primarycolor,
          ),
          body: GetBuilder<Update_receipts_controller>(builder: (controller) {
            return Container(
