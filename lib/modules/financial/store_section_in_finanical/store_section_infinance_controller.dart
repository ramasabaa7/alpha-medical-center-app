...
import 'package:project_after_update/modules/financial/store_section_in_finanical/store_section_infinance_services.dart';
...
class Store_section_in_finance_controller extends GetxController {
  bool droped = false;
  Store_section_in_finance_services services = Store_section_in_finance_services(Get.find(),Get.find());
