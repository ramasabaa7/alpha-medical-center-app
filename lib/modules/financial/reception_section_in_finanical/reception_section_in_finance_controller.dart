...
import 'package:project_after_update/modules/financial/reception_section_in_finanical/reception_section_in_finance_services.dart';
...
class Reception_section_in_finance_controller extends GetxController {
  bool droped = false;
  Reception_section_in_finance_services services = Reception_section_in_finance_services(Get.find(),Get.find());
