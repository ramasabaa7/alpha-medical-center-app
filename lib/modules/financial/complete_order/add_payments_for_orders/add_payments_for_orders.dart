...
import 'package:project_after_update/modules/financial/complete_order/add_payments_for_orders/add_payments_for_orders_controller.dart';
...
import 'package:project_after_update/modules/financial/maintenance/payments_for_maintenance/add_payments_for_maintenance_req/add_payments_for_maintenance_req_controller.dart';
...
class Add_payments_orders extends StatelessWidget {
  const Add_payments_orders({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Add_payments_orders_controller controller =
    Get.put<Add_payments_orders_controller>(Add_payments_orders_controller());
    return Scaffold(
        body: GetBuilder<Add_payments_orders_controller>(builder: (controller){
          return
            Container(
              child: ListView(
                children: [
