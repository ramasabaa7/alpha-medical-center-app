...
import 'package:project_after_update/modules/financial/complete_order/update_payments_orders/update_payments_order_controller.dart';
...
class update_payments_orders extends StatelessWidget {
  const update_payments_orders({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    update_payments_orders_controller controller =
    Get.put<update_payments_orders_controller>(update_payments_orders_controller());
    return Scaffold(
        body: GetBuilder<update_payments_orders_controller>(builder: (controller){
          return
            Container(
              child: ListView(
                children: [
