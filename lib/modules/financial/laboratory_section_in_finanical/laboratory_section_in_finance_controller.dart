...
import 'package:project_after_update/modules/financial/laboratory_section_in_finanical/laboratory_section_in_finance_services.dart';
...
class Laboratory_section_in_finance_controller extends GetxController {
  bool droped = false;
  Laboratory_section_in_finance_services services = Laboratory_section_in_finance_services(Get.find(),Get.find());
