...
class Add_maintenance_request extends StatelessWidget {
  const Add_maintenance_request({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Add_maintenance_request_controller controller =
    Get.put<Add_maintenance_request_controller>(Add_maintenance_request_controller());
    return Scaffold(
        body: GetBuilder<Add_maintenance_request_controller>(builder: (controller){
          return
            Container(
              child: ListView(
                children: [
