...
class update_maintenance_request extends StatelessWidget {
  const update_maintenance_request({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    update_maintenance_request_controller controller =
    Get.put<update_maintenance_request_controller>(update_maintenance_request_controller());
    return Scaffold(
        body: GetBuilder<update_maintenance_request_controller>(builder: (controller){
          return
            Container(
              child: ListView(
                children: [
