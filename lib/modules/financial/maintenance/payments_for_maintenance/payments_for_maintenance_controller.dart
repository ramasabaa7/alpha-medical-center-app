...
class Payments_for_maintenance_controller extends GetxController {
  Payments_for_maintenance_services services =
  Payments_for_maintenance_services(Get.find(),Get.find());
  StatusRequest? statusRequest;
  Secury_storage secury_storage = new Secury_storage();
  late int bill_id;
  late int maintenance_re_id;
  List data = [];
  List test_data = [];
  ...
  get_all_payments_maintenance_request() async {
    ...
    update();
    var response = await services.get_all_payments_maintenance_request(maintenance_re_id);
  ...
  delete_payments(int id_maintenance) async {
    statusRequest = StatusRequest.loading;
    update();
    var response = await services.delete_payments(id_maintenance);
  ...
  @override
  void onInit() {
    maintenance_re_id=Get.arguments['maintenance_req_id'];
