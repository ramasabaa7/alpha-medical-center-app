...
class Payments_for_maintenance extends StatelessWidget {
  const Payments_for_maintenance({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Payments_for_maintenance_controller controller = Get.put(Payments_for_maintenance_controller());
    return RefreshIndicator(
      onRefresh: ()async{
        await controller.get_all_payments_maintenance_request();
      },
      child: Scaffold(
        appBar: AppBar(
          toolbarHeight: 100,
        ...
        body: SafeArea(
            child: GetBuilder<Payments_for_maintenance_controller>(builder: (controller) {
                                                      ...
                                                      content: Row(
                                                        ...
                                                        children: [
                                                          GestureDetector(
                                                            onTap: (){
                                                              Get.back();
                                                              Get.toNamed("/update_payments_maintenance",arguments: {
