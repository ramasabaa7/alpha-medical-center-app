...
class update_payments_maintenance_controller extends GetxController{
  ...
  late String price;
  late String details;
  update_payments_maintenance_services services =update_payments_maintenance_services(Get.find());
  ...
  update_payments_maintenance() async{
    ...
    update();
    var response =await services.update_payments_maintenance(id,name,price,details);
