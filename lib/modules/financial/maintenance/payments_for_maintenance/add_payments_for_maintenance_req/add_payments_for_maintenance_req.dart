...
class Add_payments_maintenance_request extends StatelessWidget {
  const Add_payments_maintenance_request({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Add_payments_maintenance_controller controller =
    Get.put<Add_payments_maintenance_controller>(Add_payments_maintenance_controller());
    return Scaffold(
        body: GetBuilder<Add_payments_maintenance_controller>(builder: (controller){
          return
            Container(
              child: ListView(
                children: [
