...
class Update_bills_services {
  String bearer = "Bearer";
  Crud_get crud_get;
  Crud_delete crud_delete;
  Crud_put crud_put;
  Update_bills_services(this.crud_put,this.crud_delete,this.crud_get);
  ...
  update_bill(int bill_id ,int patient_visit_id, int insurance_company_id,String dis_type,String dis_details) async {
    String? token = await secury.read("finance_token");
    var response = await crud_put.postdata(Serverconfig.update_bill, {
      "bill_id":"${bill_id}",
