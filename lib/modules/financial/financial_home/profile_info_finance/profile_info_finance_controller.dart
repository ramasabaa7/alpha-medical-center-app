...
import 'package:project_after_update/modules/financial/financial_home/profile_info_finance/profile_info_finance_services.dart';
...
class Profile_info_finance_controller extends GetxController {
  Profile_info_finance_services services = Profile_info_finance_services(Get.find());
