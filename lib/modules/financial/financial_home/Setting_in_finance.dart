...
class Setting_in_finance extends StatelessWidget {
  const Setting_in_finance({Key? key}) : super(key: key);

  @override

  Widget build(BuildContext context) {
    Get.put(financial_home_controller());
    return GetBuilder<financial_home_controller>(builder: (controller){
      return Scaffold(
        appBar: AppBar(
          ...
          child: Container(
            ...
            child: ListView(
              children: [
                ...
                GestureDetector(
                  onTap: (){
                    Get.toNamed("/Profile_info_finance");
                  },
                  child: Container(
                    margin: EdgeInsets.only(bottom: 10),
                    padding: EdgeInsets.all(10),
