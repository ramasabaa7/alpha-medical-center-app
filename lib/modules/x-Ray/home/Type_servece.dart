...
class Type_servic extends StatelessWidget {
   final homex_rayController controller ;
 const Type_servic( {Key? key, required this.controller}) : super(key: key);
...
class Listpatients extends StatelessWidget {
  ...
  final int index;
  final homex_rayController controlar ;
