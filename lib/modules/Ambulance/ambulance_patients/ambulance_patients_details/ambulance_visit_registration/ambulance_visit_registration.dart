...
class Ambulance_visit_registration extends StatelessWidget {
  const Ambulance_visit_registration({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Ambulance_visit_registration_controller controller =Get.put(Ambulance_visit_registration_controller());
    return SafeArea(
      child: Scaffold(
          body: GetBuilder<Ambulance_visit_registration_controller>(builder: (controller) {
            return
              Container(
