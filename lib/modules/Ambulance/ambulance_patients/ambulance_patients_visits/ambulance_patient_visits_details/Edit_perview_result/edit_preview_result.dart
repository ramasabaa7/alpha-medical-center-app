...
import 'package:project_after_update/modules/Ambulance/ambulance_patients/ambulance_patients_visits/ambulance_patient_visits_details/Edit_perview_result/edit_preview_result_controller.dart';
import 'package:project_after_update/static_colors/StaticColors.dart';

class Edit_preview_result extends StatelessWidget {
  const Edit_preview_result({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Edit_preview_result_controller controller =
        Get.put(Edit_preview_result_controller());
    return Scaffold(
      body: Container(
        child: ListView(
          children: [
