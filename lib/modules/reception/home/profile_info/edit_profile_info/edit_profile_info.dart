...
class EDit_profile_info extends StatelessWidget {
  Edit_profile_info_controller controller = Get.put<Edit_profile_info_controller>(Edit_profile_info_controller());
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
          child: GetBuilder<Edit_profile_info_controller>(builder:(controller){
