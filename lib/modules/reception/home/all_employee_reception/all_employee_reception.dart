...
class All_employee_reception extends StatelessWidget {
  // const Join_request({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    all_employee_controller controller = Get.put(all_employee_controller());
    return RefreshIndicator(
        ...
        child: Scaffold(
          ...
          body: SafeArea(
              child: GetBuilder<all_employee_controller>(builder: (controller) {
            return Container(
              child: ListView(
                children: [
                  Container(
                  ...
                  GetBuilder<all_employee_controller>(builder: (controller) {
