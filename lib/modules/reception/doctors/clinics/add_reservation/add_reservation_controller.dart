...
class Add_reservation_controller extends GetxController {
  ...
  Add_reservation_services services = Add_reservation_services(Get.find());
  ...
  add_reservation() async {
   // print("the doctor id in the add reservation controller is ${id_doctor}");
    ...
    update();
    var response =
    await services.add_reservation(id_doctor, id_personal, bookingdate);
